...
**问题：** AI 说完具体内容后，习惯用抽象词汇再概括一遍，像是在打包交给读者。读者已经理解了，这一句是废话。

**改写前：**
> 我连自己为什么写、写给谁看、要达到什么目的都没想清楚。指导思想是空的，原则是空的。

**改写后：**
> 我连自己为什么写、写给谁看、要达到什么目的都没想清楚。

**原则：** 具体说完就往前走，不回头用抽象词打包。


### 14. "是……的"套抽象概念（中文直译腔）

**问题：** 把形容词塞进"是……的"框架，是英文"is ___"的直译。中文表达缺失、不足，习惯用"没有"或直接用形容词，不说"是空的"。

**需要注意的结构：** 是空的、是重要的、是必要的、是有意义的、是正确的
...
**原则：** 看到"是___的"结构，优先改成"没有"或直接用形容词。
